...
class Youtube extends Component {
	...
	componentDidMount() {
		fetch("https://www.googleapis.com/youtube/v3/search?key=AIzaSyBcV9F0WnNcIM_me16kiquBiZCTzzb3_sA&channelId=UCE_M8A5yxnLfW0KghEeajjw&part=snippet,id&order=date&maxResults=6")
